...
NOTE: The latest version of the Nutanix provider is [v2.3.0.1](https://github.com/nutanix/terraform-provider-nutanix/releases/tag/v2.3.0.1).
...
The provider is used to interact with the many resources and data sources supported by Nutanix, using Prism Central as the provider endpoint. To fully utilize the capabilities of version 2.3.0.1, ensure your Nutanix environment meets the following software requirements:
...
- Nutanix Terraform Provider Version: 2.3.0.1
