...
const configFilePath = "$GOPATH/src/github.com/ideadevice/terraform-ahv-provider-plugin/virtualmachineconfig/virtualmachineconfig.autogenerated.go"
...
const schemaFilePath = "$GOPATH/src/github.com/ideadevice/terraform-ahv-provider-plugin/virtualmachineschema/virtualmachineschema.autogenerated.go"

const structPath = "$GOPATH/src/nutanixV3/"
