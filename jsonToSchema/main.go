...
var (
	configFilePath = gopath.Path + "/src/github.com/ideadevice/terraform-ahv-provider-plugin/virtualmachineconfig/virtualmachineconfig.autogenerated.go"
	schemaFilePath = gopath.Path + "/src/github.com/ideadevice/terraform-ahv-provider-plugin/virtualmachineschema/virtualmachineschema.autogenerated.go"
	structPath = gopath.Path + "/src/nutanixV3/"
