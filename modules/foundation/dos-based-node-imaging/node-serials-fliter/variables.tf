...
Fields like hypervisor_ip, hypervisor_hostname and cvm_ip are required. Hypervisro needs to be mentioned
here or in defaults variable. All other fields are optional
nodes_info = {
    "<node1_serial_number>" : {
        cvm_ip              : "10.xx.xx.xx"
        hypervisor          : "kvm"
