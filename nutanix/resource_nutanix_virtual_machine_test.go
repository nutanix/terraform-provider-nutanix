		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttrSet("nutanix_virtual_machine.vm1", "hardware_clock_timezone"),
					resource.TestCheckResourceAttrSet("nutanix_virtual_machine.vm1", "power_state"),
					resource.TestCheckResourceAttrSet("nutanix_virtual_machine.vm1", "memory_size_mib"),
					resource.TestCheckResourceAttrSet("nutanix_virtual_machine.vm1", "num_sockets"),
					resource.TestCheckResourceAttrSet("nutanix_virtual_machine.vm1", "num_vcpus_per_socket"),
				),
			},
			{
				Config: testAccNutanixVMConfig2(r),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckNutanixVirtualMachineExists("nutanix_virtual_machine.vm1"),
					resource.TestCheckResourceAttrSet("nutanix_virtual_machine.vm1", "hardware_clock_timezone"),
				),
...
func testAccNutanixVMConfig2(r int) string {
	return fmt.Sprint(`
    provider "nutanix" {
  username = "admin"
  password = "Nutanix/1234"
