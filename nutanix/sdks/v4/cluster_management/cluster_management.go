...
import (
	...
	clustermgmt "github.com/nutanix/ntnx-api-golang-clients/clustermgmt-go-client/v4/client"
	"github.com/terraform-providers/terraform-provider-nutanix/nutanix/client"
	"github.com/terraform-providers/terraform-provider-nutanix/nutanix/sdks/v4/sdkconfig"
)

type Client struct {
	ClustersAPI *api.ClustersApi
}

func NewClusterManagementClient(credentials client.Credentials) (*Client, error) {
	var baseClient *clustermgmt.ApiClient

	pcClient := clustermgmt.NewApiClient()
	...
	return &Client{
		ClustersAPI: api.NewClustersApi(baseClient),
	}, nil
}
