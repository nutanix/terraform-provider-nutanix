	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			},
			{
				Config: networkFunctionConfig,
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttrSet(resourceNameNetworkFunctionV2_2, "id"),
					resource.TestCheckResourceAttr(resourceNameNetworkFunctionV2_2, "name", name),
					resource.TestCheckResourceAttr(resourceNameNetworkFunctionV2_2, "high_availability_mode", "ACTIVE_PASSIVE"),
					resource.TestCheckResourceAttr(resourceNameNetworkFunctionV2_2, "traffic_forwarding_mode", "VTAP"),
					resource.TestCheckResourceAttr(resourceNameNetworkFunctionV2_2, "nic_pairs.#", "2"),
					resource.TestCheckResourceAttrPair(
						resourceNameNetworkFunctionV2_2,
					...
					resource.TestCheckResourceAttr(resourceNameNetworkFunctionV2_2, "nic_pairs.0.is_enabled", "true"),
					resource.TestCheckResourceAttrPair(
						resourceNameNetworkFunctionV2_2,
					...
					resource.TestCheckResourceAttr(resourceNameNetworkFunctionV2_2, "nic_pairs.1.is_enabled", "true"),
					resource.TestCheckResourceAttr(resourceNameNetworkFunctionV2_2, "high_availability_mode", "ACTIVE_PASSIVE"),
					resource.TestCheckResourceAttr(resourceNameNetworkFunctionV2_2, "traffic_forwarding_mode", "VTAP"),
					resource.TestCheckResourceAttr(resourceNameNetworkFunctionV2_2, "nic_pairs.#", "2"),
					resource.TestCheckResourceAttrPair(
...
func TestAccV2NutanixNetworkFunctionResource_InvalidConfig(t *testing.T) {
	resource.Test(t, resource.TestCase{
        ...
        `,
				ExpectError: regexp.MustCompile("vm_reference is required"),
			},
		},
	})
}
