...
func TestAccNutanixServiceGroupV2_Basic(t *testing.T) {
	r := acctest.RandInt()
...
func TestAccNutanixServiceGroupV2_WithUpdate(t *testing.T) {
	r := acctest.RandInt()
	name := fmt.Sprintf("test-Service-group-%d", r)
...
func TestAccNutanixServiceGroupV2_WithICMP(t *testing.T) {
	r := acctest.RandInt()
	name := fmt.Sprintf("test-Service-group-%d", r)
	desc := "test Service group description"
	resource.Test(t, resource.TestCase{
...
func TestAccNutanixServiceGroupV2_WithAll(t *testing.T) {
	r := acctest.RandInt()
	name := fmt.Sprintf("test-Service-group-%d", r)
	desc := "test Service group description"
	resource.Test(t, resource.TestCase{
...
func TestAccNutanixServiceGroupV2_WithUpdateTCP(t *testing.T) {
	r := acctest.RandInt()
	name := fmt.Sprintf("test-Service-group-%d", r)
	updatedName := fmt.Sprintf("test-Service-group-%d", r+1)
	updatedDesc := "test Service group description updated"
