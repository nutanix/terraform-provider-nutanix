...
// The app_blueprint kind metadata
type AppBlueprintMetadata struct {

	// Categories for the app_blueprint
	Categories map[string]string `json:"categories,omitempty" bson:"categories,omitempty"`

	// Time when app_blueprint was created
	...
	// Time when app_blueprint was last updated
