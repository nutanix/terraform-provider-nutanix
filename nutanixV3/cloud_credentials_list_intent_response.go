...
type CloudCredentialsListIntentResponse struct {
	...
	Entities []CloudCredentialsIntentResource `json:"entities,omitempty" bson:"entities,omitempty"`

	Metadata CloudCredentialsListMetadataOutput `json:"metadata,omitempty" bson:"metadata,omitempty"`
}
