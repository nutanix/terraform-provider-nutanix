 ...
 */
func (a GroupsApi) GroupsPost(getEntitiesRequest GroupsGetEntitiesRequest) (*GroupsGetEntitiesResponse, *APIResponse, error) {
	...
	var successPayload = new(GroupsGetEntitiesResponse)
