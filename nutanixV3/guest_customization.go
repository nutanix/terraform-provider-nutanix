...
type GuestCustomization struct {
	CloudInit GuestCustomizationCloudInit `json:"cloud_init,omitempty" bson:"cloud_init,omitempty"`

	Sysprep GuestCustomizationSysprep `json:"sysprep,omitempty" bson:"sysprep,omitempty"`
}
