...
type IdempotenceIdentifiersResponse struct {
	...
	ClientIdentifier string `json:"client_identifier,omitempty" bson:"client_identifier,omitempty"`

	// The number of idempotence identifiers provided.
	Count int64 `json:"count,omitempty" bson:"count,omitempty"`

	UuidList []string `json:"uuid_list,omitempty" bson:"uuid_list,omitempty"`
}
