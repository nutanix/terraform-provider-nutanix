...
type NetworkFunctionChainMetadata struct {

	// Categories for the network_function_chain
	Categories map[string]string `json:"categories,omitempty" bson:"categories,omitempty"`

	// Time when network_function_chain was created
