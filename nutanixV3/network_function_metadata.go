...
// The network_function kind metadata
type NetworkFunctionMetadata struct {

	// Categories for the network_function
	Categories map[string]string `json:"categories,omitempty" bson:"categories,omitempty"`

	// Time when network_function was created
	...
	// Time when network_function was last updated
