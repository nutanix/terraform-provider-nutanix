...
// The prism_central kind metadata
type PrismCentralMetadata struct {

	// Categories for the prism_central
	Categories map[string]string `json:"categories,omitempty" bson:"categories,omitempty"`

	// Time when prism_central was created
	...
	// Time when prism_central was last updated
