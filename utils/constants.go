...
const (
	...
	RelEntityTypeVirtualSwitch               = "networking:config:virtual-switch"
	...
	RelEntityTypeDirectoryServerConfig       = "microseg:config:directory-server-config"
	RelEntityTypeCategoryMapping             = "microseg:config:category-mapping"
	...
	RelEntityTypeVMStartupPolicy             = "vmm:ahv:policies:vm-startup-policy"
	RelEntityTypeTemplatePlacementPolicy     = "vmm:config:template-placement-policy"
	RelEntityTypeProject                     = "multidomain:config:Project"
	RelEntityTypeResourceGroup               = "multidomain:config:nutanix-resource-group"
	RelEntityTypeImageRateLimitPolicy        = "vmm:images:config:rate-limit-policy"
...
const (
	...
	CompletionDetailsNameVMRecoveryPointExtID = "VM external ID"
