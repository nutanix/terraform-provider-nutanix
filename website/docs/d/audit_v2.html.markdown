...
See detailed information in [Nutanix Get Audit V4](https://developers.nutanix.com/api-reference?namespace=monitoring&version=v4.2#tag/Audits/operation/getAuditById).
