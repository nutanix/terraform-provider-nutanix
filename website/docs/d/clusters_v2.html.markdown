...
See detailed information in [Nutanix List Clusters V4](https://developers.nutanix.com/api-reference?namespace=clustermgmt&version=v4.3#tag/Clusters/operation/listClusters).
