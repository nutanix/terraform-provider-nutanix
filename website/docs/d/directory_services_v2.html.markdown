...
See detailed information in [Nutanix List Directory Services v4](https://developers.nutanix.com/api-reference?namespace=iam&version=v4.1.b3#tag/DirectoryServices/operation/listDirectoryServices).
