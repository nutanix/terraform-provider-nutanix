...
See detailed information in [Nutanix Get Event V4](https://developers.nutanix.com/api-reference?namespace=monitoring&version=v4.2#tag/EventsService/operation/GetEventById).
