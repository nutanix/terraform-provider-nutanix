...
See detailed information in [Nutanix Foundation Central Get the details of a single node](https://www.nutanix.dev/api_references/foundation-central/#/0222d2d05b2a6-get-the-details-of-a-single-node).