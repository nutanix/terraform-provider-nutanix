...
See detailed information in [Nutanix Get Host V4](https://developers.nutanix.com/api-reference?namespace=clustermgmt&version=v4.3#tag/Clusters/operation/getHostById).
