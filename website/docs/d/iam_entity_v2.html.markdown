...
See [Nutanix Get Entity v4](https://developers.nutanix.com/api-reference?namespace=iam&version=v4.1.b3#tag/Entities/operation/getEntityById) for API details.
