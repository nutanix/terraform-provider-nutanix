...
See detailed information in [Nutanix List Image placement policies V4](https://developers.nutanix.com/api-reference?namespace=vmm&version=v4.3#tag/ImagePlacementPolicies/operation/listPlacementPolicies)
