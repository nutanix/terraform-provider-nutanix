...
See detailed information in [Nutanix Get Image placement policy V4](https://developers.nutanix.com/api-reference?namespace=vmm&version=v4.3#tag/ImagePlacementPolicies/operation/getPlacementPolicyById)
