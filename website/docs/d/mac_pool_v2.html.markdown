---
layout: "nutanix"
page_title: "NUTANIX: nutanix_mac_pool_v2"
sidebar_current: "docs-nutanix-datasource-mac-pool-v2"
description: |-
...
```hcl
data "nutanix_mac_pool_v2" "example" {
...
* `ext_id`: (Required) External ID of the MAC address pool.

## Attributes Reference

The following attributes are exported:

* `name`: Name of the MAC address pool.
* `reference_id`: Reference identifier of the pool from the provider.
* `available_count`: Number of available MAC addresses.
