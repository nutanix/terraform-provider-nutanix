---
layout: "nutanix"
page_title: "NUTANIX: nutanix_mac_pools_v2"
sidebar_current: "docs-nutanix-datasource-mac-pools-v2"
description: |-
  Returns a list of MAC address pools available in a hardware provider connection.
---

# nutanix_mac_pools_v2
...
```hcl
data "nutanix_mac_pools_v2" "example" {
...
* `mac_pools`: List of MAC address pools. Each element has the same attributes as the [`nutanix_mac_pool_v2`](mac_pool_v2.html) datasource.
