...
See detailed information in [Nutanix Network Function v4](https://developers.nutanix.com/api-reference?namespace=networking&version=v4.4#tag/NetworkFunctions/operation/getNetworkFunctionById).
