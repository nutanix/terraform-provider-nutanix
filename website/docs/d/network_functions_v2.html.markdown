---
layout: "nutanix"
page_title: "NUTANIX: nutanix_network_functions_v2"
sidebar_current: "docs-nutanix-datasource-network-functions-v2"
description: |-
  Provides a datasource to list Network Functions.
---
...
- `limit`: (Optional) Maximum number of items per page.
- `filter`: (Optional) Filter expression. Examples:
  - `filter = "extId eq '887fddf0-b125-4da3-8110-b82bdbd21da2'"`
  - `filter = "name eq 'samplenf'"`
- `order_by`: (Optional) Order by expression. Examples:
  - `order_by = "name"`
  - `order_by = "name desc"`
...
- `network_functions`: List of network functions.

### network_functions

The `network_functions` object contains the following attributes:
...
See detailed information in [List Network Functions v4](https://developers.nutanix.com/api-reference?namespace=networking&version=v4.2#tag/NetworkFunctions/operation/listNetworkFunctions).
