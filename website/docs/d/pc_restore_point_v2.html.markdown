...
See detailed information in [Nutanix Get Restore Point V4](https://developers.nutanix.com/api-reference?namespace=prism&version=v4.4#tag/DomainManager/operation/getRestorePointById).
