...
See detailed information in [Nutanix Get PC Details V4](https://developers.nutanix.com/api-reference?namespace=prism&version=v4.4#tag/DomainManager/operation/getDomainManagerById).
