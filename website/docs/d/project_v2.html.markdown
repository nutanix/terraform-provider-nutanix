...
description: |-
  Fetches the project identified by an external identifier.
---
...
See detailed information in [Nutanix Get Project V4](https://developers.nutanix.com/api-reference?namespace=multidomain&version=v4.4.b1#tag/Projects/operation/getProjectById).