...
See detailed information in [Nutanix List Projects V4](https://developers.nutanix.com/api-reference?namespace=iam&version=v4.1.b3#tag/Projects/operation/listProjects).