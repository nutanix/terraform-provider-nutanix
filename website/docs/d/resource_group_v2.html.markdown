...
See detailed information in [Nutanix Get Resource Group V2](https://developers.nutanix.com/api-reference?namespace=multidomain&version=v4.4.b1#tag/ResourceGroups/operation/getResourceGroupById).