...
See detailed information in [Nutanix Get Role v4](https://developers.nutanix.com/api-reference?namespace=iam&version=v4.1.b3#tag/Roles/operation/getRoleById).
