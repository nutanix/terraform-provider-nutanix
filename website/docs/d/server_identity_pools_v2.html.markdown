---
layout: "nutanix"
page_title: "NUTANIX: nutanix_server_identity_pools_v2"
sidebar_current: "docs-nutanix-datasource-server-identity-pools-v2"
description: |-
  Returns a list of server identity pools available in a hardware provider connection.
---

# nutanix_server_identity_pools_v2
...
```hcl
data "nutanix_server_identity_pools_v2" "example" {
...
* `server_identity_pools`: List of server identity pools. Each element has the same attributes as the [`nutanix_server_identity_pool_v2`](server_identity_pool_v2.html) datasource.
