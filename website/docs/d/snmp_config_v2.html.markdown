...
See detailed information in [Nutanix Get SNMP Config](https://developers.nutanix.com/api-reference?namespace=clustermgmt&version=v4.3#tag/Clusters/operation/getSnmpTrapById).
