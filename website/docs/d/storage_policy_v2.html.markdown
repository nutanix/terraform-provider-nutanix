...
See detailed information in [Nutanix Get Storage Policy v4](https://developers.nutanix.com/api-reference?namespace=datapolicies&version=v4.3#tag/StoragePolicies/operation/getStoragePolicyById).