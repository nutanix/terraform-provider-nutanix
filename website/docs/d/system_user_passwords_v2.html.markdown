...
See detailed information in [Nutanix List password status of system users V4](https://developers.nutanix.com/api-reference?namespace=clustermgmt&version=v4.3#tag/PasswordManager/operation/listSystemUserPasswords).
