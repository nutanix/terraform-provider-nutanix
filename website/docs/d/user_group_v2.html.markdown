...
See detailed information in [Nutanix Get User Group v4](https://developers.nutanix.com/api-reference?namespace=iam&version=v4.1.b3#tag/UserGroups/operation/getUserGroupById).
