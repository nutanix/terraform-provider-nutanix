...
See detailed information in [Nutanix Get Virtual Machine V4](https://developers.nutanix.com/api-reference?namespace=vmm&version=v4.3#tag/Vm/operation/getVmById).
