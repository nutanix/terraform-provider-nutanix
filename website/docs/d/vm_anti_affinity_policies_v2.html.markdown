---
layout: "nutanix"
page_title: "NUTANIX: nutanix_vm_anti_affinity_policies_v2"
sidebar_current: "docs-nutanix-datasource-vm-anti-affinity-policies-v2"
description: |-
  Describes VM-VM Anti-Affinity policies
---
...
data "nutanix_vm_anti_affinity_policies_v2" "all_policies" {}

# List with pagination
data "nutanix_vm_anti_affinity_policies_v2" "paginated_policies" {
  page  = 0
  limit = 10
}

# List with filtering
data "nutanix_vm_anti_affinity_policies_v2" "filtered_policies" {
  filter = "name eq 'my-policy'"
}

# List with ordering
data "nutanix_vm_anti_affinity_policies_v2" "sorted_policies" {
  order_by = "name asc"
}

# List with multiple filters
data "nutanix_vm_anti_affinity_policies_v2" "complex_policies" {
...
* `policies` - List of all VM-VM Anti-Affinity policies

### Policies

The `policies` object is a list of VM-VM Anti-Affinity policies. Each VM-VM Anti-Affinity policy object contains the following attributes:

* `ext_id` - The external identifier of the VM-VM Anti-Affinity policy.
