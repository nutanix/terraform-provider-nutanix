...
See detailed information in [Nutanix Get VM Host Affinity Policy V4](https://developers.nutanix.com/api-reference?namespace=vmm&version=v4.3#tag/VmHostAffinityPolicies/operation/getVmHostAffinityPolicyById)
