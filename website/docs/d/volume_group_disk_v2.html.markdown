...
See detailed information in [Nutanix Get Volume Disk V4](https://developers.nutanix.com/api-reference?namespace=volumes&version=v4.3#tag/VolumeGroups/operation/getVolumeDiskById).
