...
See detailed information in [Nutanix Network Information of Unconfigured Nodes V4](https://developers.nutanix.com/api-reference?namespace=clustermgmt&version=v4.3#tag/Clusters/operation/fetchNodeNetworkingDetails).
