...
See detailed information in [Nutanix Create Image Placement Policies V4](https://developers.nutanix.com/api-reference?namespace=vmm&version=v4.3#tag/ImagePlacementPolicies/operation/createPlacementPolicy)
