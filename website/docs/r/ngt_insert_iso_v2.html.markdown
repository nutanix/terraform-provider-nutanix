...
See detailed information in [Nutanix Insert VM Guest Tools V4](https://developers.nutanix.com/api-reference?namespace=vmm&version=v4.2#tag/Vm/operation/insertVmGuestTools).
