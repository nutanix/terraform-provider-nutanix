...
See detailed information in [Nutanix Upgrade VM Guest Tools V4](https://developers.nutanix.com/api-reference?namespace=vmm&version=v4.3#tag/Vm/operation/upgradeVmGuestTools).
