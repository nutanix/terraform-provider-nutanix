...
See detailed information in [Nutanix Download an Ova V4](https://developers.nutanix.com/api-reference?namespace=vmm&version=v4.3#tag/Ovas/operation/getFileByOvaId).
