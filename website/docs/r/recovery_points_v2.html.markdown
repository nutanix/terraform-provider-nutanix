...
* `project_ext_id`: -(Optional) Project external ID to associate with the recovery point. Note: This field cannot be updated after creation.
...
See detailed information in [Nutanix Recovery Point V4](https://developers.nutanix.com/api-reference?namespace=dataprotection&version=v4.3#tag/RecoveryPoints/operation/createRecoveryPoint).
