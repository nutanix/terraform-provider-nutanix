...
See detailed information in [Nutanix Service Groups V4](https://developers.nutanix.com/api-reference?namespace=microseg&version=v4.3#tag/ServiceGroups/operation/createServiceGroup).
