...
See detailed information in [Nutanix SNMP Config](https://developers.nutanix.com/api-reference?namespace=clustermgmt&version=v4.3#tag/Clusters/operation/updateSnmpStatus) and [Nutanix SNMP Config](https://developers.nutanix.com/api-reference?namespace=clustermgmt&version=v4.3#tag/Clusters/operation/addSnmpTransport).
